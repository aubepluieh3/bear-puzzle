...
| 그림 확인 | **👀 미리보기**를 누르고 있는 동안만 보임 — **횟수 제한 있음** |

조각을 다 놓았지만 자리가 틀리면 **"아직 아니에요!"** 팝업이 알려줍니다.

### 미리보기 횟수

한 판에 몇 번만 볼 수 있습니다. 한 번 누르는 것이 한 번입니다 (누르고 있는 시간은 상관없음).
...
규칙은 `한 변 − 2` 입니다 ([`peekLimit`](src/lib/puzzle.js)).
